# -*- coding: utf-8 -*-
"""
Created on Thu Jun 18 21:51:27 2020
...
class NeuralNet():
    ...
    def __init__(self, num_nodes, weights_=[], classification=True, auto_encoder=False, penalty=0., learn_rate=0.01):
        ...
        np.seterr(all='warn')  # Set how floating-point errors are handled;warn: Print a RuntimeWarning
    
    def __str__(self):
        return "Neural Networks("

    def initWeights(self, X, nclass):
        bias = np.ones((X.shape[0],1)) # creates array filed with ones of shape (rows of x,1)
